...
RSpec.describe GovukOpenapiReference::SchemaExample do
  describe "#as_json" do
    ...
    it "generates examples for an object with an array" do
      ...
      expect(example).to match(
        "array_of_integers" => kind_of(Array),
        "array_of_strings" => kind_of(Array),
      )
    end
    ...
    def generate_example(schema)
      ...
      described_class.new(document.components.schemas.first.last).as_json
    end
  end
end
